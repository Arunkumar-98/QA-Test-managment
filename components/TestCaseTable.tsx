...
export function TestCaseTable({
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {/* Table */}
      <div className="bg-white flex-1 flex flex-col overflow-hidden pb-8">
      ...
      {/* Pagination */}
      <div className="px-6 py-6 border-t border-slate-200 bg-gradient-to-r from-slate-50/50 to-blue-50/30 shadow-sm sticky bottom-0 z-10 mb-4">
