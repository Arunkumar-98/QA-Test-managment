-- Live Sync Setup for Shared Projects
...
-- Create RLS policy
DROP POLICY IF EXISTS "Users can view their own shared project references" ON shared_project_references;
...
SELECT 'shared_project_references table created successfully' as status; 